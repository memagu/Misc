...
pygame.display.set_caption("shadowsim_v2")
...
class LineSegment:
    ...
    def draw(self):
        pygame.draw.aaline(display, color_white, (self.x1, self.y1),
                           (self.x2, self.y2))
...
class RaySource:
    ...
    def draw(self):
        pygame.draw.circle(display, color_red, (self.x, self.y), 10)
        pygame.draw.aaline(display, color_red, (self.x, self.y),
