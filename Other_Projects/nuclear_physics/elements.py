...
H3 = Element('H3', 1, 3, 3.0160492779, 378943488.0, 'beta-')
...
Be10 = Element('Be10', 4, 10, 10.013534695, 46445184000000.0, 'beta-')
...
C14 = Element('C14', 6, 14, 14.0032419884, 175322880000.0, 'beta-')
...
Na22 = Element('Na22', 11, 22, 21.99443741, 80027205.11999999, 'beta+')
...
Al26 = Element('Al26', 13, 26, 25.986891904, 22053772800000.0, 'beta+')
...
Cl36 = Element('Cl36', 17, 36, 35.968306809, 9258278400000.0, 'beta-, beta+')
...
Ar39 = Element('Ar39', 18, 39, 38.964313, 8274009600.0, 'beta-')
...
K40 = Element('K40', 19, 40, 39.963998166, 3.83864832e+16, 'beta-')
...
Ca40 = Element('Ca40', 20, 40, 39.962590863, 9.22752e+28, '2 beta+')
Ca41 = Element('Ca41', 20, 41, 40.96227792, 3057384960000.0, 'epsilon')
...
Ca46 = Element('Ca46', 20, 46, 45.953689, 8.612352e+22, '2beta-')
Ca47 = Element('Ca47', 20, 47, 46.9545424, 391910.39999999997, 'beta-')
Ca48 = Element('Ca48', 20, 48, 47.95252276, 1.7839872e+30, '2beta-')
...
Ti44 = Element('Ti44', 22, 44, 43.95968995, 1845504000.0, 'epsilon')
...
V50 = Element('V50', 23, 50, 49.94715601, 6.459264e+24, 'beta+ , beta-')
...
Cr50 = Element('Cr50', 24, 50, 49.94604183, 3.998592e+25, '2beta+')
...
Mn53 = Element('Mn53', 25, 53, 52.94128889, 115036416000000.0, 'epsilon')
...
Fe55 = Element('Fe55', 26, 55, 54.93829199, 84401049.60000001, 'epsilon')
...
Fe60 = Element('Fe60', 26, 60, 59.9340711, 80587008000000.0, 'beta-')
...
Ni59 = Element('Ni59', 28, 59, 58.9343462, 2337638400000.0, 'beta+')
...
Ni63 = Element('Ni63', 28, 63, 62.92966963, 3112750080.0, 'beta-')
...
Zn64 = Element('Zn64', 30, 64, 63.92914201, 2.153088e+28, '2beta+')
...
Zn70 = Element('Zn70', 30, 70, 69.9253192, 7.074432e+24, '2beta-')
...
Se79 = Element('Se79', 34, 79, 78.91849929, 10027238400000.0, 'beta-')
...
Kr78 = Element('Kr78', 36, 78, 77.92036494, 4.61376e+28, '2beta+')
Kr79 = Element('Kr79', 36, 79, 78.9200829, 126144.0, 'beta+')
Kr80 = Element('Kr80', 36, 80, 79.91637808, 0, None)
Kr81 = Element('Kr81', 36, 81, 80.9165912, 7043673600000.0, 'epsilon')
...
Kr85 = Element('Kr85', 36, 85, 84.9125273, 330314457.6, 'beta-')
...
Rb87 = Element('Rb87', 37, 87, 86.909180531, 1.52869248e+18, 'beta-')
...
Sr90 = Element('Sr90', 38, 90, 89.90773, 888917760.0, 'beta-')
...
Zr93 = Element('Zr93', 40, 93, 92.9064699, 49521024000000.0, 'beta-')
Zr94 = Element('Zr94', 40, 94, 93.9063108, 0, None)
Zr95 = Element('Zr95', 40, 95, 94.9080385, 5532364.8, 'beta-')
Zr96 = Element('Zr96', 40, 96, 95.9082714, 7.228224e+26, '2beta-')

Nb90 = Element('Nb90', 41, 90, 89.9112584, 52560.0, 'beta+')
Nb91 = Element('Nb91', 41, 91, 90.9069897, 20915712000.0, 'epsilon')
Nb92 = Element('Nb92', 41, 92, 91.9071881, 1067316480000000.0, 'beta+ , beta-')
Nb93 = Element('Nb93', 41, 93, 92.906373, 0, None)
Nb94 = Element('Nb94', 41, 94, 93.9072788, 624395520000.0, 'beta-')

Mo92 = Element('Mo92', 42, 92, 91.90680796, 0, None)
Mo93 = Element('Mo93', 42, 93, 92.90680958, 123033600000.0, 'epsilon')
...
Mo100 = Element('Mo100', 42, 100, 99.9074718, 2.2453632e+26, '2beta-')

Tc96 = Element('Tc96', 43, 96, 95.907868, 369792.0, 'beta+')
Tc97 = Element('Tc97', 43, 97, 96.9063667, 129492864000000.0, 'epsilon')
Tc98 = Element('Tc98', 43, 98, 97.9072124, 129185280000000.0, 'beta-')
Tc99 = Element('Tc99', 43, 99, 98.9062508, 6493098240000.0, 'beta-')
...
Rh101 = Element('Rh101', 45, 101, 100.9061606, 101502720.0, 'epsilon')
...
Pd107 = Element('Pd107', 46, 107, 106.9051282, 199929600000000.0, 'beta-')
...
Cd106 = Element('Cd106', 48, 106, 105.9064599, 1.1073024e+28, '2beta+')
Cd107 = Element('Cd107', 48, 107, 106.9066121, 23400.0, 'beta+')
Cd108 = Element('Cd108', 48, 108, 107.9041834, 5.844096e+25, '2beta+')
...
Cd113 = Element('Cd113', 48, 113, 112.90440813, 2.460672e+23, 'beta-')
Cd114 = Element('Cd114', 48, 114, 113.90336509, 6.459264e+25, '2beta-')
Cd115 = Element('Cd115', 48, 115, 114.90543751, 192456.0, 'beta-')
Cd116 = Element('Cd116', 48, 116, 115.90476315, 1.0150272e+27, '2beta-')
...
In115 = Element('In115', 49, 115, 114.903878776, 1.35644544e+22, 'beta-')

Sn112 = Element('Sn112', 50, 112, 111.90482387, 3.998592e+28, '2beta+')
...
Sn124 = Element('Sn124', 50, 124, 123.9052766, 3.691008e+28, '2beta-')
...
Sb125 = Element('Sb125', 51, 125, 124.905253, 84848891.904, 'beta-')
...
Te123 = Element('Te123', 52, 123, 122.9042698, 2.8297728e+24, 'epsilon')
...
Te128 = Element('Te128', 52, 128, 127.90446128, 7.4127744e+31, '2beta-')
Te129 = Element('Te129', 52, 129, 128.90659646, 4194.0, 'beta-')
Te130 = Element('Te130', 52, 130, 129.906222748, 9.22752e+31, '2beta-')
...
I129 = Element('I129', 53, 129, 128.9049837, 482906880000000.0, 'beta-')
...
Xe124 = Element('Xe124', 54, 124, 123.905892, 4.921344e+21, '2beta+')
...
Xe134 = Element('Xe134', 54, 134, 133.90539466, 1.7839872e+30, '2beta-')
Xe135 = Element('Xe135', 54, 135, 134.9072278, 32904.0, 'beta-')
Xe136 = Element('Xe136', 54, 136, 135.907214484, 7.382016e+28, '2beta-')

Cs132 = Element('Cs132', 55, 132, 131.9064339, 559872.0, 'beta+ , beta-')
Cs133 = Element('Cs133', 55, 133, 132.905451961, 0, None)
Cs134 = Element('Cs134', 55, 134, 133.906718503, 63522247.68, 'beta-, epsilon')
Cs135 = Element('Cs135', 55, 135, 134.905977, 70744320000000.0, 'beta-')
Cs136 = Element('Cs136', 55, 136, 135.9073114, 1126656.0, 'beta-')
Cs137 = Element('Cs137', 55, 137, 136.90708923, 925212672.0, 'beta-')

Ba130 = Element('Ba130', 56, 130, 129.9063207, 0, '2beta+')
Ba131 = Element('Ba131', 56, 131, 130.906941, 993600.0, 'beta+')
Ba132 = Element('Ba132', 56, 132, 131.9050611, 9.22752e+28, '2beta+')
Ba133 = Element('Ba133', 56, 133, 132.9060074, 324531878.4, 'epsilon')
...
La137 = Element('La137', 57, 137, 136.9064504, 1845504000000.0, 'epsilon')
La138 = Element('La138', 57, 138, 137.9071149, 3.1373568e+18, 'beta+ , beta-')
La139 = Element('La139', 57, 139, 138.9063563, 0, None)
La140 = Element('La140', 57, 140, 139.9094806, 145026.72, 'beta-')

Ce136 = Element('Ce136', 58, 136, 135.90712921, 2.153088e+21, '2beta+')
Ce137 = Element('Ce137', 58, 137, 136.90776236, 32400.0, 'beta+')
Ce138 = Element('Ce138', 58, 138, 137.905991, 2.768256e+21, '2beta+')
...
Ce142 = Element('Ce142', 58, 142, 141.9092504, 1.53792e+24, '2beta-')
...
Nd144 = Element('Nd144', 60, 144, 143.910093, 7.0436736e+22, 'alpha')
...
Nd150 = Element('Nd150', 60, 150, 149.9209022, 2.7990144e+26, '2beta-')
...
Sm146 = Element('Sm146', 62, 146, 145.913047, 3168115200000000.0, 'alpha')
Sm147 = Element('Sm147', 62, 147, 146.9149044, 3.2603904e+18, 'alpha')
Sm148 = Element('Sm148', 62, 148, 147.9148292, 2.153088e+23, 'alpha')
Sm149 = Element('Sm149', 62, 149, 148.9171921, 0, None)
Sm150 = Element('Sm150', 62, 150, 149.9172829, 0, None)
Sm151 = Element('Sm151', 62, 151, 150.9199398, 2768256000.0, 'beta-')
...
Eu150 = Element('Eu150', 63, 150, 149.9197077, 1134984960.0, 'beta+')
Eu151 = Element('Eu151', 63, 151, 150.9198578, 5.228928e+25, 'alpha')
Eu152 = Element('Eu152', 63, 152, 151.9217522, 415761292.8, 'beta+ , beta-')
Eu153 = Element('Eu153', 63, 153, 152.921238, 0, None)
Eu154 = Element('Eu154', 63, 154, 153.922987, 264552998.40000004, 'beta-, epsilon')

Gd152 = Element('Gd152', 64, 152, 151.9197995, 3.3219072e+21, 'alpha')
...
Gd160 = Element('Gd160', 64, 160, 159.9270624, 9.535104e+26, '2beta-')

Tb158 = Element('Tb158', 65, 158, 157.9254209, 5536512000.0, 'beta+ , beta-')
...
Lu176 = Element('Lu176', 71, 176, 175.9426897, 1.15651584e+18, 'beta-')
...
Hf174 = Element('Hf174', 72, 174, 173.9400461, 6.15168e+22, 'alpha')
...
W180 = Element('W180', 74, 180, 179.9467108, 2.0300544e+25, '2beta+')
W181 = Element('W181', 74, 181, 180.9481978, 10471680.0, 'epsilon')
W182 = Element('W182', 74, 182, 181.94820394, 0, None)
W183 = Element('W183', 74, 183, 182.95022275, 2.0608128e+28, 'alpha')
...
Re187 = Element('Re187', 75, 187, 186.9557501, 1.33183872e+18, 'beta-, alpha')

Os184 = Element('Os184', 76, 184, 183.9524885, 1.7224704e+21, 'alpha')
Os185 = Element('Os185', 76, 185, 184.9540417, 8087039.999999999, 'epsilon')
Os186 = Element('Os186', 76, 186, 185.953835, 6.15168e+22, 'alpha')
...
Pt190 = Element('Pt190', 78, 190, 189.9599297, 1.999296e+19, 'alpha')
Pt191 = Element('Pt191', 78, 191, 190.9616729, 244512.0, 'epsilon')
Pt192 = Element('Pt192', 78, 192, 191.9610387, 0, None)
Pt193 = Element('Pt193', 78, 193, 192.9629824, 1537920000.0, 'epsilon')
...
Tl204 = Element('Tl204', 81, 204, 203.9738639, 116359027.2, 'beta-, epsilon')
Tl205 = Element('Tl205', 81, 205, 204.9744278, 0, None)

Pb203 = Element('Pb203', 82, 203, 202.9733911, 186912.0, 'epsilon')
Pb204 = Element('Pb204', 82, 204, 203.973044, 4.306176e+24, 'alpha')
Pb205 = Element('Pb205', 82, 205, 204.9744822, 532120320000000.0, 'epsilon')
...
Pb210 = Element('Pb210', 82, 210, 209.9841889, 682836480.0, 'beta-, alpha')

Bi206 = Element('Bi206', 83, 206, 205.9784993, 539395.2000000001, 'beta+')
Bi207 = Element('Bi207', 83, 207, 206.978471, 970427520.0, 'beta+')
Bi208 = Element('Bi208', 83, 208, 207.9797425, 11319091200000.0, 'beta+')
...
Po208 = Element('Po208', 84, 208, 207.9812461, 89137843.2, 'alpha, beta+')
Po209 = Element('Po209', 84, 209, 208.9824308, 3814041600.0, 'alpha, beta+')
...
Ra226 = Element('Ra226', 88, 226, 226.0254103, 49213440000.0, 'alpha, 14C')
Ra227 = Element('Ra227', 88, 227, 227.0291783, 2532.0, 'beta-')
Ra228 = Element('Ra228', 88, 228, 228.0310707, 176860800.0, 'beta-')
...
Ac227 = Element('Ac227', 89, 227, 227.0277523, 669671884.8, 'beta-, alpha')
...
Th228 = Element('Th228', 90, 228, 228.0287413, 58825440.0, 'alpha, 20O')
Th229 = Element('Th229', 90, 229, 229.0317627, 243975628800.0, 'alpha')
Th230 = Element('Th230', 90, 230, 230.0331341, 2319183360000.0, 'alpha, 24ne, SF')
Th231 = Element('Th231', 90, 231, 231.0363046, 91872.0, 'beta-, alpha')
Th232 = Element('Th232', 90, 232, 232.0380558, 4.306176e+17, 'alpha, SF')
...
Pa231 = Element('Pa231', 91, 231, 231.0358842, 1007645184000.0, 'alpha, SF')
...
U232 = Element('U232', 92, 232, 232.0371563, 2119253760.0000002, 'alpha, SF')
U233 = Element('U233', 92, 233, 233.0396355, 4896737280000.0, 'alpha, SF')
U234 = Element('U234', 92, 234, 234.0409523, 7551187200000.0, 'alpha, SF')
U235 = Element('U235', 92, 235, 235.0439301, 2.16539136e+16, 'alpha, SF')
U236 = Element('U236', 92, 236, 236.0455682, 720361728000000.0, 'alpha, SF')
U237 = Element('U237', 92, 237, 237.0487304, 583200.0, 'beta-')
U238 = Element('U238', 92, 238, 238.0507884, 1.374285312e+17, 'alpha, SF')
...
Np236 = Element('Np236', 93, 236, 236.04657, 4706035200000.0, 'epsilon, beta-, alpha')
Np237 = Element('Np237', 93, 237, 237.0481736, 65946009600000.0, 'alpha, SF')
...
Pu236 = Element('Pu236', 94, 236, 236.0460581, 87907507.2, 'alpha, SF')
Pu237 = Element('Pu237', 94, 237, 237.0484098, 3943296.0, 'epsilon, alpha')
Pu238 = Element('Pu238', 94, 238, 238.0495601, 2697511680.0, 'alpha, SF')
Pu239 = Element('Pu239', 94, 239, 239.0521636, 741585024000.0, 'alpha, SF')
Pu240 = Element('Pu240', 94, 240, 240.0538138, 201805862400.0, 'alpha, SF')
Pu241 = Element('Pu241', 94, 241, 241.0568517, 440737113.6, 'beta-, alpha, SF')
Pu242 = Element('Pu242', 94, 242, 242.0587428, 11534400000000.0, 'alpha, SF')
Pu243 = Element('Pu243', 94, 243, 243.0620036, 17841.600000000002, 'beta-')
Pu244 = Element('Pu244', 94, 244, 244.0642053, 2460672000000000.0, 'alpha, SF')
Pu245 = Element('Pu245', 94, 245, 245.067826, 37800.0, 'beta-')

Am240 = Element('Am240', 95, 240, 240.0553, 182880.0, 'beta+ , alpha')
Am241 = Element('Am241', 95, 241, 241.0568293, 13306083840.0, 'alpha, SF')
Am242 = Element('Am242', 95, 242, 242.0595494, 57672.0, 'beta-, epsilon')
Am243 = Element('Am243', 95, 243, 243.0613813, 226504857600.0, 'alpha, SF')
Am244 = Element('Am244', 95, 244, 244.0642851, 36360.0, 'beta-, SF')

Cm242 = Element('Cm242', 96, 242, 242.058836, 14065920.000000002, 'alpha, SF')
Cm243 = Element('Cm243', 96, 243, 243.0613893, 895069440.0, 'alpha, epsilon, SF')
Cm244 = Element('Cm244', 96, 244, 244.0627528, 556727040.0, 'alpha, SF')
Cm245 = Element('Cm245', 96, 245, 245.0654915, 259078003200.0, 'alpha, SF')
Cm246 = Element('Cm246', 96, 246, 246.0672238, 144749030400.0, 'alpha, SF')
Cm247 = Element('Cm247', 96, 247, 247.0703541, 479831040000000.0, 'alpha')
Cm248 = Element('Cm248', 96, 248, 248.0723499, 10703923200000.0, 'alpha, SF')
Cm249 = Element('Cm249', 96, 249, 249.0759548, 3849.0000000000005, 'beta-')
Cm250 = Element('Cm250', 96, 250, 250.078358, 255294720000.0, 'SF, alpha, beta-')
Cm251 = Element('Cm251', 96, 251, 251.082286, 1008.0, 'beta-')

Bk246 = Element('Bk246', 97, 246, 246.068673, 155520.0, 'beta+')
Bk247 = Element('Bk247', 97, 247, 247.0703073, 42446592000.0, 'alpha')
Bk248 = Element('Bk248', 97, 248, 248.073088, 276825600.0, 'alpha')
...
Cf249 = Element('Cf249', 98, 249, 249.0748539, 10796198400.0, 'alpha, SF')
Cf250 = Element('Cf250', 98, 250, 250.0764062, 402319872.0, 'alpha, SF')
Cf251 = Element('Cf251', 98, 251, 251.0795886, 27621043200.0, 'alpha, SF')
Cf252 = Element('Cf252', 98, 252, 252.0816272, 81355968.0, 'alpha, SF')
