...
def create_files():
    ...
    if not os.path.exists("README.txt"):
        ...
        with open("README.txt", "w") as RM:
            RM.write("Settings:\n")
            RM.write("1. Choose to alphabetically sort your list by setting 'Sort list:' to either 'True' of 'False'.")
            RM.write("\n2. You can change any number of items by using the 'settings.txt' file. Use the following ")
            RM.write("format: <old value> -> <new value>.\n   Example: 8 -> 6. The example will change ")
            RM.write("the number of eight items to six (8 goat milk --> 6 goat milk).\n\n")
            RM.write("How to use:\n")
            RM.write("1. Put your list in 'input.txt' and run 'ListCalculator.py'. Input must be entered accordingly: ")
            RM.write("<number of items> <item>.\n   Example input: 10 brown sugar.\n")
            RM.write("2. Output will be provided in the console and in a text file called: 'output.txt'.")
